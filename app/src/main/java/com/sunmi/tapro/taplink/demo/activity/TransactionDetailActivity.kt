...
//            append("Query Result:\n\n")
    ...
    private fun generateTransactionRequestId(): String {
        return "${Constants.TRANSACTION_REQUEST_ID_PREFIX}${System.currentTimeMillis()}"
    }
    ...
    private fun launchTransactionProgressActivity(transaction: Transaction) {
        ...
        // Add original transaction ID and request ID for follow-up operations (e.g. TIP_ADJUST)
        ...
        if (originalTxn != null) {
            ...
            intent.putExtra("original_transaction_request_id", originalTxn.transactionRequestId)
        }
